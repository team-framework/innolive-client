...
- Personal information inquiries: [support@innolive.studio](mailto:support@innolive.studio)
...
You may use the account and face management features provided in the app, or make a request to [support@innolive.studio](mailto:support@innolive.studio). The Operations Team verifies the minimum information needed to confirm the requester’s identity or agency authority.
...
| Email | [support@innolive.studio](mailto:support@innolive.studio) |
...
The publication date and effective date of this policy are **September 19, 2026**. The effective date of the previous policy is **September 17, 2026**. Processing that requires separate consent because of a change begins after that consent is obtained.
