...
The Operations Team manages email-login passwords, refresh tokens, and broadcast-session ownership verification tokens in hashed form. Encryption is applied to YouTube connection tokens and stored Apple connection tokens.
...
InnoLive uses YouTube API Services.
...
You can revoke InnoLive’s access permissions on the Google account connection permission management page. You can also request deletion of related information remaining in InnoLive through the personal information inquiry channel.

## 12. Changes to this policy

When the Operations Team changes this policy, it notifies the website or app of the changes and the effective date. Changes that require separate consent are subject to consent before the relevant processing begins.

The publication date and effective date of this policy are **September 17, 2026**. The effective date of the previous policy is **September 10, 2026**. Processing that requires separate consent because of a change begins after that consent is obtained.
