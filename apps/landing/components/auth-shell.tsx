...
export function AuthShell({ children }: { children: ReactNode }) {
  return (
    <main id="main" data-page="auth" className="bg-background-primary">
      <div className="flex min-h-dvh flex-col items-center justify-center px-[var(--page-gutter)] py-16 lg:py-24">
        <div className="flex w-full max-w-[86rem] flex-col overflow-clip rounded-[24px] bg-background-secondary shadow-[0_0_32px_0_#0000000d] min-[48rem]:flex-row">
          <div className="flex w-full flex-col items-center justify-center gap-7 px-8 pb-8 pt-[4.5rem] min-[48rem]:max-w-[36rem]">
            {children}
          </div>
        ...
        <nav
          className="mt-8 flex flex-wrap items-center justify-center gap-2 text-base font-medium text-text-primary"
          aria-label="약관"
        >
          <Link
            href="/privacy"
